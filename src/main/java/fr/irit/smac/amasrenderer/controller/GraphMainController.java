...
public class GraphMainController implements Initializable {
    ...
    GraphMouseWheelController graphMouseWheelController;
    GraphAddEdgeMouseController addEdgeMouseController;
    GraphDefaultMouseController defaultMouseController;
